...
/**
 Base class for all GiftPlanner views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the GiftPlanner view hierarchy (such as wrapped iOS UIViews) was touched.
