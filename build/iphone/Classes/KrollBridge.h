...
@interface GiftPlannerObject : KrollCoverageObject {
#else
@interface GiftPlannerObject : KrollObject {
#endif
@private
...
extern NSString * GiftPlanner$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GiftPlannerObject *_giftplanner;
    KrollObject* console;
	BOOL shutdown;
