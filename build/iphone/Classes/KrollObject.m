 ...
 * Copyright (c) 2009-2011 by GiftPlanner, Inc. All Rights Reserved.
...
//@interface GiftPlannerObject : NSObject
//@end

@interface GiftPlannerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GiftPlannerObject class]])
		{
			for (NSString *key in [[(GiftPlannerObject*)o modules] allKeys])
			{
