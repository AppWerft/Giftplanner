...
static NSString * const kGiftPlannerJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_giftplannerInjection
{
	...
	[html appendString:kGiftPlannerJavascript];
...
{
	// attempt to make well-formed HTML and inject in our GiftPlanner bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _giftplannerInjection]];
