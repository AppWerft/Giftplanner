...
// in simulator we redefine to format for GiftPlanner Developer console
...
{\
	NSString * exceptionName = [@"org.giftplanner." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.giftplanner";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGiftPlannerNativeItemNone = -1, 
	UIGiftPlannerNativeItemSpinner = -2,
	UIGiftPlannerNativeItemProgressBar = -3,
	
	UIGiftPlannerNativeItemSlider = -4,
	UIGiftPlannerNativeItemSwitch = -5,
	UIGiftPlannerNativeItemMultiButton = -6,
	UIGiftPlannerNativeItemSegmented = -7,
	
	UIGiftPlannerNativeItemTextView = -8,
	UIGiftPlannerNativeItemTextField = -9,
	UIGiftPlannerNativeItemSearchBar = -10,
	
	UIGiftPlannerNativeItemPicker = -11,
	UIGiftPlannerNativeItemDatePicker = -12,
	
	UIGiftPlannerNativeItemInfoLight = -13,
	UIGiftPlannerNativeItemInfoDark = -14,
	
	UIGiftPlannerNativeItemDisclosure = -15,
	
	UIGiftPlannerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GiftPlanner instances of
